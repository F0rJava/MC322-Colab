...
public class ScreenLevel2 implements Screen{
    ...
    public ScreenLevel2(final Crazychef game, Controller controller){
        this.game = game;
        ...
        chef = new Chef(80*8,80*5);//pos na matriz [4][8]
    ...
    public void render(float delta){
        ...
        for(int i = 0; i < 9; i++) {
            for (int j = 1; j < 16; j++) {
                if(i == 0 && (j == 1 || j == 15)){ //Mesa
                    if(kitchen.getFloor(i, j).dontHaveActors()) { //Mesa
                        Table tableFront1 = new Table(80*j, 80*i);
                        kitchen.getFloor(i, j).addActors(tableFront1);
                    }
                ...
                } else if((i == 2 || i == 4) && (j == 1 || j == 15)){ //Fornos
                    if(kitchen.getFloor(i, j).dontHaveActors()) {
                        Oven oven = new Oven(80*j, 80*i, new Texture(Gdx.files.internal("Kitchen/ovenV.png")));
                ...
                } else if (i == 3 && (j == 1 || j == 15)) { //Gerador Hamburguer
                    if(kitchen.getFloor(i, j).dontHaveActors()) {
                    ...
                    aux = (Food) kitchen.getFloor(i, j).getFood();
                    game.batch.draw(aux.getBaseTexture(), aux.x, aux.y, aux.width, aux.height);
                } else if (i == 3 && j == 8) { //Tábua de Corte
                    if(kitchen.getFloor(i, j).dontHaveActors()) {
                    ...
                    if(aux != null) {
                        ...
                        chef.setCanMove(true);
                } else if (i == 3 && j == 4) { //Gerador de Tomate
                    if(kitchen.getFloor(i, j).dontHaveActors()) {
                    ...
                    aux = (Food) kitchen.getFloor(i, j).getFood();
                    game.batch.draw(aux.getBaseTexture(), aux.x, aux.y, aux.width, aux.height);
                } else if (i == 3 && j == 12) { //Gerador de Alface
                    if(kitchen.getFloor(i, j).dontHaveActors()) {
                    ...
                    aux = (Food) kitchen.getFloor(i, j).getFood();
                    game.batch.draw(aux.getBaseTexture(), aux.x, aux.y, aux.width, aux.height);
                } else if (i == 4 && j == 8) { //Gerador de Queijo
                    if(kitchen.getFloor(i, j).dontHaveActors()) {
                    ...
                    auxTable = (Table) kitchen.getFloor(i, j).getTable();
                    game.batch.draw(tableImageH, auxTable.x, auxTable.y, auxTable.width, auxTable.height);
                } else if (i == 6 && (j == 7 || j == 9)) { //Gerador de Prato
                    if(kitchen.getFloor(i, j).dontHaveActors()) {
                    ...
                    aux = (Food) kitchen.getFloor(i, j).getFood();
                    game.batch.draw(aux.getBaseTexture(), aux.x, aux.y, aux.width, aux.height);
                } else if (i == 6 && j == 8) { //Delivery de Pedidos
                    if(kitchen.getFloor(i, j).dontHaveActors()){
